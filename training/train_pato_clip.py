...
def main():
    ...
    pato_model = PATOQwen2_5_VisionTransformer.from_pretrained(
        model_path,
        config=config,
        device_map="cuda",
    ...
    if script_args.resume:
        pato_model.load_pato_components(pato_state_dict_path=script_args.pato_state_dict_path)
    else: 
        pato_model.load_pato_components()
